...
ALTER TABLE services MODIFY COLUMN form_type ENUM('NONE', 'GOVT_LOAN', 'PRIVATE_LOAN', 'TAX_FORM', 'INSURANCE_FORM') NOT NULL DEFAULT 'NONE';
ALTER TABLE service_applications MODIFY COLUMN status ENUM('FRESH', 'DOCUMENTS_UPLOAD', 'HOLD', 'LOGIN', 'DOCUMENTS_PENDING', 'BANKAR_PENDENCY', 'REJECT', 'APPROVED', 'COMPLETED') DEFAULT 'FRESH';
ALTER TABLE services MODIFY COLUMN form_type ENUM('NONE', 'GOVT_LOAN', 'PRIVATE_LOAN', 'TAX_FORM', 'INSURANCE_FORM', 'CREDIT_CARD_FORM') NOT NULL DEFAULT 'NONE';


ALTER TABLE white_label_clients ADD COLUMN landing_page_data TEXT NULL;
ALTER TABLE roles MODIFY COLUMN code ENUM('SUPER_ADMIN','RM','SALES_EXEC','PARTNER_ADMIN','WHITE_LABEL');